  ...
  const modules: Module[] = [
    ...
    // 3. Personnel (👥)
    {
      ...
      items: [
        ...
        {
          name: 'Ogólny Grafik Zespołu',
          href: '/urlopy?tab=team',
          icon: (
        ...
        },
        {
          ...
          visible: ['ADMIN', 'ADMINISTRATOR', 'MASTER ADMIN', 'MASTER_ADMIN', 'ZARZAD', 'ZARZĄD', 'BOARD', 'KIEROWNIK', 'MANAGER', 'DYREKTOR', 'DIRECTOR'].includes(userRoleUpper),
        },
      ],
    },
    // 4. Audyty (📋)
